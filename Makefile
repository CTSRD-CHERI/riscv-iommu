...
defines ?=
compile_flag += +cover=bcfst+/dut -incr -64 -nologo -quiet -suppress 13262 -suppress 3999 -suppress 2240 -suppress 3009 -suppress 8303 -suppress 8386 -suppress 8360 -permissive +define+$(defines)
...
compile.tcl:
	$(BENDER) script vsim \
		--vlog-arg="$(compile_flag)  -work  $(library) -suppress 2583 -suppress 13314 -suppress 8386 -suppress 2240  -suppress 8303 +nospecify +notimingchecks" --vcom-arg=" -work $(library)" \
