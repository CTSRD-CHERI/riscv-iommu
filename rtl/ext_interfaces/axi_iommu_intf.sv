...
//
// Description: An AXI4 interface extended with support for untranslated transactions.
...
interface AXI_BUS_EXT #(
  ...
  parameter int unsigned AXI_SID_WIDTH  = 0,
  parameter int unsigned AXI_SSID_WIDTH = 0
);
  ...
  // AXI support for untranslated transactions
  typedef logic [AXI_SID_WIDTH-1:0]  sid_t;
  typedef logic                      ssidv_t;
  typedef logic [AXI_SSID_WIDTH-1:0] ssid_t;
