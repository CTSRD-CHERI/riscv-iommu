...
module rv_iommu_tw_sv39x4_pc #(
    ...
    input  logic [CVA6Cfg.VLEN-1:0]          iova_i,     // IOVA
    ...
    output logic [CVA6Cfg.SVX-1:0]               bad_gpaddr_o,       // to report bits [63:2] of the GPA in case of a Guest Page Fault
    ...
    input  logic [CVA6Cfg.GPPNW-1:0]     flush_vpn_i,    // IOVA to tag entries to be flushed
    ...
    logic [15:0] gscid;
    logic [19:0] pscid;
    logic [CVA6Cfg.PPNW-1:0] iohgatp_ppn, iosatp_ppn;

    // PTW implicit translations for CDW walks
    logic                           cdw_implicit_access;
    logic [CVA6Cfg.GPPNW-1:0]        pdt_gppn;
    logic                           cdw_done;
    logic                           flush_cdw;
    logic [CVA6Cfg.PPNW-1:0]         iohgatp_ppn_fw;
    logic                           is_ddt_walk;
    ...
    // MSI DC fields
    logic [CVA6Cfg.GPPNW-1:0]    msi_addr_mask;
    logic [CVA6Cfg.GPPNW-1:0]    msi_addr_pattern;
    ...
    logic [CVA6Cfg.PPNW-1:0] ptw_iohgatp_ppn;
    ...
    logic [CVA6Cfg.GPPNW-1:0]    iotlb_up_vpn;
    ...
    logic                       ptw_up_2S_2M;
    logic                       ptw_up_2S_1G;
    logic [CVA6Cfg.GPPNW-1:0]    ptw_up_vpn;
    ...
    logic                       msi_up_1S_2M;
    logic                       msi_up_1S_1G;
    logic [CVA6Cfg.GPPNW-1:0]    msi_up_vpn;
    ...
    logic                       gpaddr_is_msi;
    logic [CVA6Cfg.GPPNW-1:0]    msi_vpn;
    logic                       msi_1S_2M;
    logic                       msi_1S_1G;
    ...
    if (MSITrans != rv_iommu::MSI_DISABLED) begin : gen_msi_support
        ...
        assign msi_addr_mask    = dc_ext.msi_addr_mask.mask[CVA6Cfg.GPPNW-1:0];
        assign msi_addr_pattern = dc_ext.msi_addr_pattern.pattern[CVA6Cfg.GPPNW-1:0];
        
        assign iova_is_msi      =   (msi_enabled) & 
                                    (is_store) &
                                    ((iova_i[(CVA6Cfg.GPLEN-1):12] & ~msi_addr_mask) == (msi_addr_pattern & ~msi_addr_mask));
