...
module rv_iommu_trans_ctl_wrap #(
    ...
    // AXI Cut
    //---------
    axi_comp_req_t     comp_axi_req_cut;
    axi_comp_resp_t    comp_axi_resp_cut;
    axi_cut #(
        .Bypass     (1'b0),
        ...
        .clk_i      (clk_i),
        .rst_ni     (rst_ni),
        .slv_req_i  (comp_axi_req_cut),
        .slv_resp_o (comp_axi_resp_cut),
        .mst_req_o  (comp_axi_req_o),
        .mst_resp_i (comp_axi_resp_i)
    );
    ...
    if (RVIOMMUCfg.MSITrans == rv_iommu_cfg::MSI_BT_MRIF) begin : gen_mrif_support
        ...
        axi_demux #(
            ...
            .mst_reqs_o     ({axi_ign_req, comp_axi_req_cut, axi_err_req}),
            .mst_resps_i    ({axi_ign_resp, comp_axi_resp_cut, axi_err_resp})
        );
    ...
    // Do not generate transaction ignoring mechanism
        ...
        axi_demux #(
            ...
            .mst_reqs_o     ({comp_axi_req_cut, axi_err_req}),
            .mst_resps_i    ({comp_axi_resp_cut, axi_err_resp})
        );
